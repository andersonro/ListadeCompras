package br.com.arodevsistemas.listadecompras.core
...
abstract class UseCase<Param, Source> {
    ...
    abstract class ListParam<Param> : UseCase<Param, Flow<Source>>() {
        abstract suspend fun execute(): Flow<Source>

        final override suspend fun execute(param: Param) =
            throw UnsupportedOperationException()
